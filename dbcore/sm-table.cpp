...
std::unordered_map<std::string, UnorderedIndex*> TableDescriptor::index_map;
...
void TableDescriptor::SetPrimaryIndex(UnorderedIndex *index, const std::string &name) {
  ALWAYS_ASSERT(index);
...
void TableDescriptor::AddSecondaryIndex(UnorderedIndex *index, const std::string &name) {
  ALWAYS_ASSERT(index);
