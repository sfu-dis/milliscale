...
if __name__ =='__main__':
    filename = "tpcc_delta_dequeue_"
    out_dir = "./tpcc_delta_dequeue"
    expr.execute(common_cmd, COMMANDS, "tpcc_delta_dequeue_",  "./tpcc_delta_dequeue", run=True)
    expr.parse(COMMANDS, FIELDS, filename=filename, log_dir=out_dir, out_csv="tpcc_delta_dequeue.csv")
