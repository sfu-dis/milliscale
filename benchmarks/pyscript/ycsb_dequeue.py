...
COMMANDS = [
    ...
    expr.Command(
        name="distribution",
        value=["uniform", "zipfian"],
        pattern="-ycsb_hot_table_rng={}",
...
if __name__ =='__main__':
    filename = "ycsb_delta_dequeue_"
    out_dir = "./ycsb_delta_dequeue"
    expr.execute(common_cmd, COMMANDS, filename,  out_dir, run=False)
    # expr.parse(COMMANDS, FIELDS, filename=filename, log_dir=out_dir, out_csv="ycsb_delta_dequeue.csv")
